...
$c_Lcom_brewery_web_frontend_message_MessageEvent$.prototype = new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$h_O();
...
$c_Lcom_brewery_web_frontend_message_MessageEvent$.prototype.submitMessage__Lorg_scalajs_dom_HTMLFormElement__Lorg_scalajs_dom_WebSocket__V = (function(form, webSocket) {
  ...
  var inputString = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$f_T__trim__T($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n(formData).apply__O__O("message-content")))));
  if (((inputString === null) || $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$f_T__isBlank__Z($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n(inputString)))) {
    return (void 0);
  }
  ...
  if ((($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n(formData).apply__O__O("to-user-id"))) !== "") || ($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n(formData).apply__O__O("to-username"))) !== ""))) {
    message.toUserId = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n(formData).apply__O__O("to-user-id")));
    message.toUsername = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n(formData).apply__O__O("to-username")));
  }
  message.fromUserId = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n(formData).apply__O__O("user-id")));
  ...
  webSocket.send($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$as_T(JSON.stringify(message)));
...
$c_Lcom_brewery_web_frontend_message_MessageEvent$.prototype.buildMessageWebsocket__Lorg_scalajs_dom_MessageEvent__V = (function(messageEvent) {
  ...
  var response = JSON.parse($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$as_T(messageEvent.data));
  if (($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n(response.message)) === "deleted")) {
    var \u03b41$ = messages.find($j_internal$002df33bfacc298d8dab923476fe9af133b88098a05b.$m_sc_StringOps$().format$extension__T__sci_Seq__T("input[value='%s']", $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$m_sr_ScalaRunTime$().genericWrapArray__O__sci_ArraySeq(new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$ac_O([response.data.messageId]))));
    var \u03b42$ = \u03b41$.parent();
    var \u03b43$ = \u03b42$.parent();
    \u03b43$.remove();
    return (void 0);
  ...
  \u03b4message.find(".message-content").html($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$as_T(message.content));
  ...
  new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$c_Lio_udash_wrappers_jquery_JQuery$JQueryWrapper(jquery).on__T__F2__Lio_udash_wrappers_jquery_JQuery("click", new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$c_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc(((element, jQueryEvent) => {
    ...
    var $x_5 = new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$c_T2("url", "/message/delete");
    var $x_4 = new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$c_T2("method", "DELETE");
    ...
    var fields = $x_2.wrapRefArray__AO__sci_ArraySeq(new ($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$d_T2.getArrayOf().constr)([new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$c_T2("messageId", s)]));
    ...
    var $x_3 = new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$c_T2("data", _2);
    ...
    var fields$1 = $x_6.wrapRefArray__AO__sci_ArraySeq(new ($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$d_T2.getArrayOf().constr)([$x_5, $x_4, $x_3, new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$c_T2("success", _2$1)]));
    return $x_7.ajax($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$m_sjs_js_special_package$().objectLiteral__sci_Seq__sjs_js_Object(fields$1));
  })));
  messages.append(\u03b4message);
  var this$12 = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$m_sci_Map$();
  ...
  var this$15 = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$n(animation);
  var y = messages.prop("scrollHeight");
  animation = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$as_sci_Map(this$15.updated__O__O__sci_MapOps("scrollTop", y));
  $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$m_Lio_udash_wrappers_jquery_JQuery$();
  var \u03b47$ = new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$c_Lio_udash_wrappers_jquery_JQuery$JQueryWrapper(messages);
  \u03b47$.animate__sci_Map__I__T__F1__Lio_udash_wrappers_jquery_JQuery(animation, 50, "swing", \u03b47$.animate$default$4__F1());
});
var $d_Lcom_brewery_web_frontend_message_MessageEvent$ = new $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$TypeData().initClass($c_Lcom_brewery_web_frontend_message_MessageEvent$, "com.brewery.web.frontend.message.MessageEvent$", ({
