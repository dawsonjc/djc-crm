...
$c_Lcom_brewery_web_frontend_message_MessageEvent$.prototype.submitMessage__Lorg_scalajs_dom_HTMLFormElement__Lorg_scalajs_dom_WebSocket__V = (function(form, webSocket) {
  ...
  var inputString = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$f_T__trim__T($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T(formData.apply__O__O("message-content")));
  if (((inputString === null) || $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$f_T__isBlank__Z(inputString))) {
    return (void 0);
  }
  ...
  if ((($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T(formData.apply__O__O("to-user-id")) !== "") || ($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T(formData.apply__O__O("to-username")) !== ""))) {
    message.toUserId = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T(formData.apply__O__O("to-user-id"));
    message.toUsername = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T(formData.apply__O__O("to-username"));
  }
  message.fromUserId = $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T(formData.apply__O__O("user-id"));
...
$c_Lcom_brewery_web_frontend_message_MessageEvent$.prototype.buildMessageWebsocket__Lorg_scalajs_dom_MessageEvent__V = (function(messageEvent) {
  ...
  if (($j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$dp_toString__T(response.message) === "deleted")) {
  ...
  \u03b4message.find(".message-content").html(message.content);
  ...
  var this$15 = animation;
  var y = messages.prop("scrollHeight");
  animation = this$15.updated__O__O__sci_MapOps("scrollTop", y);
  $j_internal$002d07235935c771c9429268cb101d7f2e2e7f60988c.$m_Lio_udash_wrappers_jquery_JQuery$();
